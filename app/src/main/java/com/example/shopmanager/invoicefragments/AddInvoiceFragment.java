...
//            mParam2 = getArguments().getString(ARG_PARAM2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_add_invoice, container, false);
        //getChildFragmentManager().beginTransaction().addToBackStack("invoices_frag_tag").replace(R.id.invoice_frame,AddCustomerFragment.newInstance()).commit();
